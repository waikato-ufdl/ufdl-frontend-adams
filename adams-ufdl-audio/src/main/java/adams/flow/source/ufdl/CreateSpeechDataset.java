...
/**
 * Creates a speech dataset and forwards the dataset object.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class CreateSpeechDataset
  ...
  public String globalInfo() {
    return "Creates a speech dataset and forwards the dataset object.";
  }
  ...
  protected Dataset createDataset() throws Exception {
      return m_Client.action(SpeechDatasets.class).create(
