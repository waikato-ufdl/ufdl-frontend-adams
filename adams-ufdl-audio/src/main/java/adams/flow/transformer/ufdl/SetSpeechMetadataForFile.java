...
/**
 * Sets the metadata of the specified file in the dataset coming in.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class SetSpeechMetadataForFile
  extends AbstractSpeechDatasetTransformerAction
  implements StorageUser {

  private static final long serialVersionUID = -1421130988687306299L;

  /** the name of the file to get the annotations for. */
  ...
  public String globalInfo() {
    return "Sets the metadata of the specified file in the dataset coming in.";
  }
  ...
  /**
   * Sets the name of the file to set the metadata for.
   *
  ...
  /**
   * Returns the name of the file to set the metadata for.
   *
   * @return 		the name
   */
  ...
  public String nameTipText() {
    return "The name of the file to set the metadata for.";
  }
  ...
  protected Object doTransform(Dataset dataset, MessageCollection errors) {
    ...
    try {
      ...
      errors.add("Failed to set metadata for file '" + m_Name + "' in dataset: " + dataset, e);
    }
