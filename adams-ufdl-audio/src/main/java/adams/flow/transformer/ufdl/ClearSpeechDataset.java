...
/**
 * Clears the speech dataset either via PK or datasetname.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class ClearSpeechDataset
  ...
  public String globalInfo() {
    return "Clears the speech dataset either via PK or dataset name.";
  }
