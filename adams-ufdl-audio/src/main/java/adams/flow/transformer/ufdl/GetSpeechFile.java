...
/**
 * Obtains the specified file from the dataset passing through and forwards the downloaded filename.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class GetSpeechFile
  ...
  public String globalInfo() {
    return "Obtains the specified file from the dataset passing through and forwards the downloaded filename.";
  }
  ...
  public String nameTipText() {
    return "The name of the file to download from the dataset.";
  }
  ...
  protected Object doTransform(Dataset dataset, MessageCollection errors) {
	...
	errors.add("Failed to retrieve file '" + m_Name + "' from dataset: " + dataset);
      else
        result = m_OutputFile.getAbsolutePath();
    }
    catch (Exception e) {
      errors.add("Failed to retrieve file '" + m_Name + "' from dataset: " + dataset, e);
    }
