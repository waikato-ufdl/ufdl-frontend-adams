...
/*
 * LoadImageClassificationDataset.java
...
/**
 * Loads the image classification dataset either via PK or dataset name.
 *
...
public class LoadImageClassificationDataset
  ...
  public String globalInfo() {
    return "Loads the image classification dataset either via PK or dataset name.";
  }
