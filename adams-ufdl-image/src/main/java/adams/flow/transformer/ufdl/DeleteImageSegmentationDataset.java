...
/*
 * DeleteImageSegmentationDataset.java
...
/**
 * Deletes the image segmentation dataset either via PK or datasetname.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class DeleteImageSegmentationDataset
  ...
  public String globalInfo() {
    return "Deletes the image segmentation dataset either via PK or dataset name.";
  }
