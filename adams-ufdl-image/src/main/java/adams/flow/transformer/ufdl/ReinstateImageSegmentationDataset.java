...
/*
 * ReinstateImageSegmentationDataset.java
...
/**
 * Reinstates the image segmentation dataset either via PK or datasetname.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class ReinstateImageSegmentationDataset
  ...
  public String globalInfo() {
    return "Reinstates the image segmentation dataset either via PK or dataset name.";
  }
