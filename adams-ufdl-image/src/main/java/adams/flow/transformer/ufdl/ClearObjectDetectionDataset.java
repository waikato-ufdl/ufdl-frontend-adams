...
/*
 * ClearObjectDetectionDataset.java
...
/**
 * Clears the object detection dataset either via PK or datasetname.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class ClearObjectDetectionDataset
  ...
  public String globalInfo() {
    return "Clears the object detection dataset either via PK or dataset name.";
  }
