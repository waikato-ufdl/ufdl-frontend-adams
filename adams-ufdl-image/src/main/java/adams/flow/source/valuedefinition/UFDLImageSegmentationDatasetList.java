...
/*
 * UFDLImageSegmentationDatasetList.java
...
/**
 * For selecting an image segmentation dataset.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class UFDLImageSegmentationDatasetList
  ...
  public String globalInfo() {
    return "For selecting an image segmentation dataset.";
  }
  ...
  protected List<Struct2<Integer, String>> listItems() {
    ...
    try {
      ...
      getLogger().log(Level.SEVERE, "Failed to retrieve list of image segmentation datasets!", e);
    }
