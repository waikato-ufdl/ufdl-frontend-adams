...
/*
 * UFDLObjectDetectionDatasetChooser.java
 * Copyright (C) 2020 University of Waikato, Hamilton, NZ
 */

package adams.flow.source.valuedefinition;

import adams.gui.chooser.UFDLObjectDetectionDatasetChooserPanel;
import adams.gui.core.PropertiesParameterPanel;

/**
 * For selecting a UFDL object detection datasets.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class UFDLObjectDetectionDatasetChooser
  ...
  public String globalInfo() {
    return "For selecting UFDL object detection datasets.";
  }
  ...
  public boolean addToPanel(PropertiesParameterPanel panel) {
    UFDLObjectDetectionDatasetChooserPanel  chooser;

    if (!check())
      return false;

    chooser  = new UFDLObjectDetectionDatasetChooserPanel();
