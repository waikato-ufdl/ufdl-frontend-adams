...
/*
 * UFDLImageClassificationDatasetChooser.java
...
import adams.gui.chooser.UFDLImageClassificationDatasetChooserPanel;
import adams.gui.core.PropertiesParameterPanel;

/**
 * For selecting a UFDL image classification datasets.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class UFDLImageClassificationDatasetChooser
  ...
  public String globalInfo() {
    return "For selecting UFDL image classification datasets.";
  }
  ...
  public boolean addToPanel(PropertiesParameterPanel panel) {
    UFDLImageClassificationDatasetChooserPanel  chooser;

    if (!check())
      return false;

    chooser  = new UFDLImageClassificationDatasetChooserPanel();
