...
/*
 * ListImageClassificationDatasets.java
...
/**
 * Outputs a spreadsheet with all the image classification datasets.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class ListImageClassificationDatasets
  ...
  public String globalInfo() {
    return "Outputs a spreadsheet with all the image classification datasets.";
  }
  ...
  public String getAdditionalInformation() {
    return new UFDLImageClassificationDatasetToSpreadSheet().getAdditionalInformation();
  }
