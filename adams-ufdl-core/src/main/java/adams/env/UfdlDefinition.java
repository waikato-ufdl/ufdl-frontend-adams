...
/**
 * Definition for the UFDL props file.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 */
public class UfdlDefinition
  ...
  /** the key as constant. */
  public final static String KEY = "ufdl";
  ...
  public void update(AbstractEnvironment env) {
    replace(env, Project.NAME + "/ml/ufdl");
  }
}
