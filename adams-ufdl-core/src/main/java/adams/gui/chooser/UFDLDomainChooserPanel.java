...
/**
 * Allows the user to select domains.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class UFDLDomainChooserPanel
  extends AbstractUFDLSpreadSheetBasedChooserPanel<Domain> {
   ...
   */
  @Override
  protected Domain loadObject(String id) throws Exception {
    return m_Connection.getClient().domains().load(id);
  }
   ...
   */
  @Override
  protected Domain loadObject(int pk) throws Exception {
    return m_Connection.getClient().domains().load(pk);
  }
   ...
   */
  @Override
  protected Domain[] newArray(int len) {
    return new Domain[len];
  }
  ...
  protected AbstractUFDLObjectToSpreadSheetConversion getConversion() {
    return new UFDLDomainToSpreadSheet();
  }
   ...
   */
  @Override
  protected int getPK(Domain object) {
    return object.getPK();
  }
