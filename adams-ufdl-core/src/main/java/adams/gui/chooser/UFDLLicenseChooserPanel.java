...
/**
 * Allows the user to select licenses.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class UFDLLicenseChooserPanel
  extends AbstractUFDLSpreadSheetBasedChooserPanel<License> {
   ...
   */
  @Override
  protected License loadObject(String id) throws Exception {
    return m_Connection.getClient().licenses().load(id);
  }
  ...
  protected AbstractUFDLObjectToSpreadSheetConversion getConversion() {
    return new UFDLLicenseToSpreadSheet();
  }
   ...
   */
  @Override
  protected int getPK(License object) {
    return object.getPK();
  }
