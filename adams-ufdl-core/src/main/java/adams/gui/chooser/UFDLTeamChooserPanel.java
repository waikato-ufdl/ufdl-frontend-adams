...
/**
 * Allows the user to select teams.
 *
...
public class UFDLTeamChooserPanel
   ...
   */
  @Override
  protected Struct2<Integer, String> toStruct(Team value) {
   ...
   */
  @Override
  protected Team loadObject(String id) throws Exception {
    return m_Connection.getClient().teams().load(id);
  }
   ...
   */
  @Override
  protected Team loadObject(int pk) throws Exception {
    return m_Connection.getClient().teams().load(pk);
  }
   ...
   */
  @Override
  protected Team[] newArray(int len) {
    return new Team[len];
  }
  ...
  protected AbstractUFDLObjectToSpreadSheetConversion getConversion() {
    return new UFDLTeamToSpreadSheet();
  }
   ...
   */
  @Override
  protected int getPK(Team object) {
    return object.getPK();
  }
   ...
   */
  @Override
  protected Team[] getAvailableObjects() throws Exception {
    return m_Connection.getClient().teams().list(m_Filter.generate(new MessageCollection())).toArray(new Team[0]);
  }
