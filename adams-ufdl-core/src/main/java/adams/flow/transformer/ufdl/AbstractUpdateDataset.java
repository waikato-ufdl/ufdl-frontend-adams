...
/**
 * Ancestor for actions that update datasets.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public abstract class AbstractUpdateDataset
   ...
   */
  protected abstract Dataset updateDataset(Dataset dataset) throws Exception;
  ...
  protected Object doTransform(Dataset dataset, MessageCollection errors) {
    ...
    result = null;
    try {
      result = updateDataset(dataset);
    }
    catch (Exception e) {
      errors.add("Failed to update dataset!", e);
    }
