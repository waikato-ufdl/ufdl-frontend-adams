...
/**
 * Reinstates the dataset either via PK or datasetname.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class ReinstateDataset
  ...
  public String globalInfo() {
    return "Reinstates the dataset either via PK or dataset name.";
  }
