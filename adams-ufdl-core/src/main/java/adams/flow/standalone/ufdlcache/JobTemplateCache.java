 ...
 */
public class JobTemplateCache
  extends AbstractIDResolutionCache<JobTemplate> {
   ...
   */
  public JobTemplateCache(UFDLConnection connection, int timeToLive) {
