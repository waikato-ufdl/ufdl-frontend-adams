...
public class DockerImageCache
  extends AbstractIDResolutionCache<DockerImage> {
   ...
   */
  public DockerImageCache(UFDLConnection connection, int timeToLive) {
