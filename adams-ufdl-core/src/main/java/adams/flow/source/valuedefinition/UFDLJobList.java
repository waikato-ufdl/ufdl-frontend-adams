...
/**
 * For selecting a UFDL job.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class UFDLJobList
  ...
  public String globalInfo() {
    return "For selecting a UFDL job.";
  }
  ...
  protected List<Struct2<Integer, String>> listItems() {
    ...
    try {
      for (Job job: m_Connection.getClient().jobs().list()) {
      ...
      getLogger().log(Level.SEVERE, "Failed to retrieve list of jobs!", e);
    }
