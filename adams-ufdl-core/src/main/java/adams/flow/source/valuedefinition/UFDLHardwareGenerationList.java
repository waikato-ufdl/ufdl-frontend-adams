...
/*
 * UFDLHardwareGenerationList.java
...
/**
 * For selecting a UFDL hardware generation.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class UFDLHardwareGenerationList
  ...
  public String globalInfo() {
    return "For selecting a UFDL hardware generation.";
  }
  ...
  protected List<Struct2<Integer, String>> listItems() {
    ...
    try {
      ...
      getLogger().log(Level.SEVERE, "Failed to retrieve list of hardware generations!", e);
    }
