...
import adams.gui.chooser.UFDLFrameworkChooserPanel;
import adams.gui.core.PropertiesParameterPanel;

/**
 * For selecting a UFDL frameworks.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class UFDLFrameworkChooser
  ...
  public String globalInfo() {
    return "For selecting UFDL frameworks.";
  }
  ...
  public boolean addToPanel(PropertiesParameterPanel panel) {
    UFDLFrameworkChooserPanel	chooser;

    if (!check())
      return false;

    chooser  = new UFDLFrameworkChooserPanel();
