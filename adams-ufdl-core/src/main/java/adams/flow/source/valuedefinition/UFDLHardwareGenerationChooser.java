...
/*
 * UFDLHardwareGenerationChooser.java
...
import adams.gui.chooser.UFDLHardwareGenerationChooserPanel;
import adams.gui.core.PropertiesParameterPanel;

/**
 * For selecting a UFDL hardware generations.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class UFDLHardwareGenerationChooser
  ...
  public String globalInfo() {
    return "For selecting UFDL hardware generations.";
  }
  ...
  public boolean addToPanel(PropertiesParameterPanel panel) {
    UFDLHardwareGenerationChooserPanel	chooser;

    if (!check())
      return false;

    chooser  = new UFDLHardwareGenerationChooserPanel();
