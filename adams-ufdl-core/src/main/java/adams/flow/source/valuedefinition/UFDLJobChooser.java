...
import adams.gui.chooser.UFDLJobChooserPanel;
import adams.gui.core.PropertiesParameterPanel;

/**
 * For selecting a UFDL jobs.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class UFDLJobChooser
  ...
  public String globalInfo() {
    return "For selecting UFDL jobs.";
  }
  ...
  public String stateTipText() {
    return "The state that the jobs must have in order to be listed.";
  }
  ...
  public boolean addToPanel(PropertiesParameterPanel panel) {
    UFDLJobChooserPanel	chooser;

    if (!check())
      return false;

    chooser  = new UFDLJobChooserPanel();
