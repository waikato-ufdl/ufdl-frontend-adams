...
/*
 * UFDLJobTemplateChooser.java
 * Copyright (C) 2020 University of Waikato, Hamilton, NZ
 */

package adams.flow.source.valuedefinition;

import adams.gui.chooser.UFDLJobTemplateChooserPanel;
import adams.gui.core.PropertiesParameterPanel;

/**
 * For selecting a UFDL job templates.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class UFDLJobTemplateChooser
  ...
  public String globalInfo() {
    return "For selecting UFDL job templates.";
  }
  ...
  public boolean addToPanel(PropertiesParameterPanel panel) {
    UFDLJobTemplateChooserPanel	chooser;

    if (!check())
      return false;

    chooser  = new UFDLJobTemplateChooserPanel();
