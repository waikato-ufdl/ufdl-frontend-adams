...
/*
 * UFDLProjectChooser.java
 * Copyright (C) 2020 University of Waikato, Hamilton, NZ
 */

package adams.flow.source.valuedefinition;

import adams.gui.chooser.UFDLProjectChooserPanel;
import adams.gui.core.PropertiesParameterPanel;

/**
 * For selecting a UFDL projects.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class UFDLProjectChooser
  ...
  public String globalInfo() {
    return "For selecting UFDL projects.";
  }
  ...
  public String stateTipText() {
    return "The state that the projects must have in order to be listed.";
  }
  ...
  public boolean addToPanel(PropertiesParameterPanel panel) {
    UFDLProjectChooserPanel	chooser;

    if (!check())
      return false;

    chooser  = new UFDLProjectChooserPanel();
