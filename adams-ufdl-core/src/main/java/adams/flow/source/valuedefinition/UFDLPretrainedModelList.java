...
/**
 * For selecting a UFDL pretrained model.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class UFDLPretrainedModelList
  ...
  public String globalInfo() {
    return "For selecting a UFDL pretrained model.";
  }
  ...
  protected List<Struct2<Integer, String>> listItems() {
    ...
    try {
      for (PretrainedModel model : m_Connection.getClient().pretrainedModels().list()) {
      ...
      getLogger().log(Level.SEVERE, "Failed to retrieve list of pretrained models!", e);
    }
