...
import adams.gui.chooser.UFDLLicenseChooserPanel;
import adams.gui.core.PropertiesParameterPanel;

/**
 * For selecting a UFDL licenses.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class UFDLLicenseChooser
  ...
  public String globalInfo() {
    return "For selecting UFDL licenses.";
  }
  ...
  public boolean addToPanel(PropertiesParameterPanel panel) {
    UFDLLicenseChooserPanel	chooser;

    if (!check())
      return false;

    chooser  = new UFDLLicenseChooserPanel();
