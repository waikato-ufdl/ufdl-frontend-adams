...
import adams.gui.chooser.UFDLCudaVersionChooserPanel;
import adams.gui.core.PropertiesParameterPanel;

/**
 * For selecting a UFDL cuda versions.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class UFDLCudaVersionChooser
  ...
  public String globalInfo() {
    return "For selecting UFDL cuda versions.";
  }
  ...
  public boolean addToPanel(PropertiesParameterPanel panel) {
    UFDLCudaVersionChooserPanel	chooser;

    if (!check())
      return false;

    chooser  = new UFDLCudaVersionChooserPanel();
