...
/**
 * For selecting a UFDL datasets.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class UFDLDatasetChooser
  ...
  public String globalInfo() {
    return "For selecting UFDL datasets.";
  }
  ...
  public boolean addToPanel(PropertiesParameterPanel panel) {
    UFDLDatasetChooserPanel	chooser;

    if (!check())
      return false;

    chooser  = new UFDLDatasetChooserPanel();
