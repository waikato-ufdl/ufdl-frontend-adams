...
/**
 * For selecting a UFDL docker images.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class UFDLDockerImageChooser
  ...
  public String globalInfo() {
    return "For selecting UFDL docker images.";
  }
  ...
  public boolean addToPanel(PropertiesParameterPanel panel) {
    UFDLDockerImageChooserPanel	chooser;

    if (!check())
      return false;

    chooser  = new UFDLDockerImageChooserPanel();
