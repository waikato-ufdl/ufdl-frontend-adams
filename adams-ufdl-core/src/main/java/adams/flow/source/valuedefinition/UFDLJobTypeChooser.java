...
/*
 * UFDLJobTypeChooser.java
 * Copyright (C) 2020 University of Waikato, Hamilton, NZ
 */

package adams.flow.source.valuedefinition;

import adams.gui.chooser.UFDLJobTypeChooserPanel;
import adams.gui.core.PropertiesParameterPanel;

/**
 * For selecting a UFDL job types.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class UFDLJobTypeChooser
  ...
  public String globalInfo() {
    return "For selecting UFDL job types.";
  }
  ...
  public boolean addToPanel(PropertiesParameterPanel panel) {
    UFDLJobTypeChooserPanel	chooser;

    if (!check())
      return false;

    chooser  = new UFDLJobTypeChooserPanel();
