...
/**
 * For selecting a UFDL job type.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class UFDLJobTypeList
  ...
  public String globalInfo() {
    return "For selecting a UFDL job type.";
  }
  ...
  protected List<Struct2<Integer, String>> listItems() {
    ...
    try {
      ...
      getLogger().log(Level.SEVERE, "Failed to retrieve list of job types!", e);
    }
