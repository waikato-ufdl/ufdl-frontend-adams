...
\begin{tight_itemize}
  \item \textit{DatasetList} -- for selecting a dataset
  \item \textit{LicenseList} -- for selecting a license
  \item \textit{ProjectList} -- for selecting a project
  \item \textit{TeamList} -- for selecting a team
  \item \textit{UserList} -- for selecting a user
\end{tight_itemize}
