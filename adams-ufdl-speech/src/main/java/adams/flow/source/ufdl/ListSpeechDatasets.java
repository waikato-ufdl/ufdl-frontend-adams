...
/**
 * Outputs a spreadsheet with all the speech datasets.
 *
...
public class ListSpeechDatasets
  ...
  public String globalInfo() {
    return "Outputs a spreadsheet with all the speech datasets.";
  }
  ...
  public String getAdditionalInformation() {
    return new UFDLSpeechDatasetToSpreadSheet().getAdditionalInformation();
  }
  ...
  protected Object doGenerate(MessageCollection errors) {
    ...
    UFDLSpeechDatasetToSpreadSheet conv;
    String			msg;
    ...
    try {
      ...
      conv  = new UFDLSpeechDatasetToSpreadSheet();
