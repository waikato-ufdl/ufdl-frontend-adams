...
/**
 * Updates a speech dataset and forwards the dataset object.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class UpdateSpeechDataset
  ...
  public String globalInfo() {
    return "Updates a speech dataset and forwards the dataset object.";
  }
  ...
  protected Dataset updateDataset(Dataset dataset) throws Exception {
      return m_Client.action(SpeechDatasets.class).update(
