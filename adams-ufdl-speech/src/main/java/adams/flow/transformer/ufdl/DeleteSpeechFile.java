...
/**
 * Deletes the specified file from the dataset passing through.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class DeleteSpeechFile
  ...
  public String globalInfo() {
    return "Deletes the specified file from the dataset passing through.";
  }
  ...
  public String nameTipText() {
    return "The name of the file to delete from the dataset.";
  }
  ...
  protected Object doTransform(Dataset dataset, MessageCollection errors) {
    ...
    try {
      ...
      errors.add("Failed to delete file '" + m_Name + "' from dataset: " + dataset, e);
    }
